...
| **Tuần 4** | **Phân tích hình thái, Liên hệ thủy điện & Báo cáo** | \- Phân tích biến động hình thái lòng sông tại các khu vực trọng điểm (Long Biên, Nhật Tân, Vĩnh Tuy). \- Đối chiếu với dữ liệu thủy văn phục vụ phân tích. \- Hoàn thiện báo cáo và chuẩn bị slide trình bày kết quả. \- Đề xuất hướng phát triển GEE Web App cảnh báo sớm  | Ngày cuối tháng | Báo cáo hoàn chỉnh; Bộ slide trình bày; Script và tài liệu hướng dẫn sử dụng; Các bản đồ và biểu đồ trực quan phục vụ phân tích.  |
