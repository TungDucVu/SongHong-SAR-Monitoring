"""
Script to test Random Forest shoreline extraction with n_trees = 50 for 2024 Dry across all 3 reaches.
Compares performance metrics (Points, Min, Median, Mean, RMSE, P95, Hausdorff) against 80, 100, and 150 trees.
"""
...
def main():
    print("=============================================================")
    print(" 2024 DRY SHORELINE EXTRACTION EXPERIMENT: n_trees = 50")
    print("=============================================================")
    ...
    print("\n=============================================================")
    print(f" EXPERIMENT RESULTS FOR 2024 DRY (n_trees = 50)")
    print("=============================================================")
    for res in [res1, res2, res3]:
        print(f"\n--- {res['Reach']} (n_trees=50) ---")
