...
def run_pipeline_for_reach3(year=2024, season='dry'):
    ...
    out_s1_path = os.path.join(output_dir, f"reach3_s1_shoreline_{year}_{season}.geojson")
    out_s2_path = os.path.join(output_dir, f"reach3_s2_ref_{year}_{season}.geojson")
    ...
    html_out_path = os.path.join(output_dir, f"reach3_interactive_map_{year}_{season}.html")
...
def main():
    ...
    run_pipeline_for_reach3(year=2024, season='dry')
    run_pipeline_for_reach3(year=2024, season='wet')
